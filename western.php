...
<div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
  <div class="carousel-inner">
      <div class="carousel-item active">
         <img class="d-block w-100" src="http://localhost/punjabi/images/western_ban1.jpg" height="400px" alt="First slide">
      </div>
       <div class="carousel-item">
         <img class="d-block w-100" src="http://localhost/punjabi/images/western_ban7.jpg" height="400px" alt="Second slide">
       </div>
...
<section class="services py-5 text-center">
  <h3 class="text-center " id="h12">Western Dresses</h3>
  <hr id="hr1">
          <div class="container">
              <div class="row">
                  <!--Single Service-->
...
<a data-toggle="modal" data-target="#exampleModa2">
 <img class="card-img-top" src="http://localhost/punjabi/images/Rudraaksha.jpeg" alt="Card image cap">
</a>
  ...
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Rudraaksha</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      ...
      <!------------------------tabs started------------------------------>
                                              ...
                                              <li class="nav-item">
                                                  <a class="nav-link active" href="#pf1" role="tab" data-toggle="tab">
                                                            <img src="http://localhost/punjabi/images/Rudraaksha.jpeg"  height="123px" width="40%">
                                                    </a>
                                              </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" href="#buzz1" role="tab" data-toggle="tab">
                                                         <img src="http://localhost/punjabi/images/Rudraaksha_side1.jpeg" height="123px" width="40%">
                                                     </a>
                                                </li>
                                                <li class="nav-item">
                                                      <a class="nav-link" href="#references1" role="tab" data-toggle="tab" >
                                                           <img src="http://localhost/punjabi/images/Rudraaksha_side2.jpeg" height="123px" width="40%">
                                                      </a>
                                                </li>
                                                <li class="nav-item">
                                                       <a class="nav-link" href="#imgur1" role="tab" data-toggle="tab" >
                                                           <img src="http://localhost/punjabi/images/Rudraaksha_side3.jpeg" height="123px" width="40%">
                                                       </a>
                                                 </li>
                                            </ul>
                                       ...
                                       <div class="tab-content modal-lg">
                                           <div role="tabpanel" class="tab-pane fade show active" id="pf1">
                                                 <div class="row">
                                                     <div class="col-md-4">
                                                           <img src="http://localhost/punjabi/images/Rudraaksha.jpeg" height="373px" width="60%">
                                                      </div>
                                                      <div class="col-md-8">
                                                            <div class="container py-3">
                                                                     <h5>Women Maxi Pink Dress With Mask</h5><br>
                                                                      <i class="fas fa-rupee-sign text-center">&nbsp;&nbsp;<span style="color:black;">369</span></i><br>
                                                                       <br>
                                           ...
                                           <div role="tabpanel" class="tab-pane fade" id="buzz1">
                                              <div class="row">
                                                     <div class="col-md-4">
                                                           <img src="http://localhost/punjabi/images/Rudraaksha_side1.jpeg" height="373px" width="69%">
                                                      </div>
                                                       ...
                                                       <div class="col-md-8">
                                                               ...
                                                               <div class="container py-3">
                                                                        ...
                                                                        <span style="color:black;">369</span></i><br>
                                                                            <br>
                                                                         <h4>Available offers</h4>
                                                                        <p class="justify-content-left" ><i class="fas fa-tag"></i>&nbsp;&nbsp;Special PriceGet extra 25% off (price inclusive of discount)T&C</p>
                                          ...
                                          <div role="tabpanel" class="tab-pane fade" id="references1">
                                                <div class="row">
                                                    <div class="col-md-4">
                                                          <img src="http://localhost/punjabi/images/Rudraaksha_side2.jpeg"  height="373px" width="69%">
                                                     </div>
                                                     <div class="col-md-8">
                                                          <div class="container py-3">
                                                                <h5>Women Maxi Pink Dress With Mask</h5><br>
                                         ...
                                         <div role="tabpanel" class="tab-pane fade" id="imgur1">
                                               <div class="row">
                                                   <div class="col-md-4">
                                                          <img src="http://localhost/punjabi/images/Rudraaksha_side3.jpeg" height="373px" width="69%">
                                                    </div>
...
<!---------modal closed------>
  <div class="card-body">
    <h5 class="card-title">Rudraaksha   </h5>
    <p class="card-text">Women Maxi Pink Dress With Mask</p>
     <p><i class="fas fa-rupee-sign text-center">&nbsp;&nbsp;<span style="color:black;">359</span></i><br><br>
 ...
 <img class="card-img-top" src="http://localhost/punjabi/images/FANCIFY.jpeg" alt="Card image cap">
</a>
...
<div class="modal fade" id="exampleModa3" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">FANCIFY  </h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      ...
      <!------------------------tabs started------------------------------>
                                              ...
                                              <li class="nav-item">
                                                  <a class="nav-link active" href="#pf3" role="tab" data-toggle="tab">
                                                            <img src="http://localhost/punjabi/images/FANCIFY.jpeg"  height="123px" width="45%">
                                                    </a>
                                              </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" href="#buzz3" role="tab" data-toggle="tab">
                                                         <img src="http://localhost/punjabi/images/FANCIFY_side1.jpeg" height="123px" width="45%">
                                                     </a>
                                                </li>
                                       ...
                                       <div class="tab-content modal-lg">
                                           <div role="tabpanel" class="tab-pane fade show active" id="pf3">
                                                 <div class="row">
                                                     <div class="col-md-4">
                                                           <img src="http://localhost/punjabi/images/FANCIFY.jpeg" height="373px" width="60%">
                                                      </div>
                                                      <div class="col-md-8">
                                                            <div class="container py-3">
                                                                     <h5>Women Gown Purple Dress</h5><br>
                                                                      <i class="fas fa-rupee-sign text-center">&nbsp;&nbsp;<span style="color:black;">549</span></i><br>
                                                                       <br>
                                                                      <h4>Available offers</h4>
                                                                      <p class="justify-content-left" ><i class="fas fa-tag"></i>&nbsp;&nbsp;Special PriceGet extra 25% off (price inclusive of discount)T&C</p>
                                                                      <p class="justify-content-left"><i class="fas fa-tag">
                                           ...
                                           <div role="tabpanel" class="tab-pane fade" id="buzz3">
                                              <div class="row">
                                                     <div class="col-md-4">
                                                           <img src="http://localhost/punjabi/images/FANCIFY_side1.jpeg" height="373px" width="69%">
                                                      </div>
                                                       ...
                                                       <div class="col-md-8">
                                                               ...
                                                               <div class="container py-3">
                                                                        <h5>Women Gown Purple Dress</h5><br>
                                                                        <i class="fas fa-rupee-sign text-center">&nbsp;&nbsp;
                                                                        <span style="color:black;">549</span></i><br>
                                                                            <br>
                                                                         <h4>Available offers</h4>
                                                                        <p class="justify-content-left" ><i class="fas fa-tag"></i>&nbsp;&nbsp;Special PriceGet extra 25% off (price inclusive of discount)T&C</p>
                                                                       <p class="justify-content-left"><i class="fas fa-tag"></i>&nbsp;&nbsp;Bank Offer15% Instant discount on first Flipkart Pay Later order of 500 and aboveT&C</p>
...
<!---------modal closed------>
  <div class="card-body">
    <h5 class="card-title">FANCIFY  
  </h5>
    <p class="card-text">Women Gown Purple Dress.</p>
     <p><i class="fas fa-rupee-sign text-center">&nbsp;&nbsp;<span style="color:black;">549</span></i><br><br>
    <i class="fas fa-star"><i class="fas fa-star"><i class="fas fa-star-half-alt"><i class="far fa-star"></i></i></i></i></i></p>
 ...
 <img class="card-img-top" src="http://localhost/punjabi/images/Micozy.jpeg" alt="Card image cap">
</a>
...
<div class="modal fade" id="exampleModa4" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Micozy
                                                                      </h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      ...
      <!------------------------tabs started------------------------------>
                                              ...
                                              <li class="nav-item">
                                                  <a class="nav-link active" href="#pf4" role="tab" data-toggle="tab">
                                                            <img src="http://localhost/punjabi/images/Micozy.jpeg"  height="123px" width="45%">
                                                    </a>
                                              </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" href="#buzz4" role="tab" data-toggle="tab">
                                                         <img src="http://localhost/punjabi/images/Micozy_side1.jpeg" height="123px" width="45%">
                                                     </a>
                                                </li>
                                       ...
                                       <div class="tab-content modal-lg">
                                           <div role="tabpanel" class="tab-pane fade show active" id="pf4">
                                                 <div class="row">
                                                     <div class="col-md-4">
                                                           <img src="http://localhost/punjabi/images/Micozy.jpeg" height="373px" width="60%">
                                                      </div>
                                                      <div class="col-md-8">
                                                            <div class="container py-3">
                                                                     <h5>Women Skater Pink Dress</h5><br>
                                                                      <i class="fas fa-rupee-sign text-center">&nbsp;&nbsp;<span style="color:black;">274</span></i><br>
                                                                       <br>
                                                                      <h4>Available offers</h4>
                                                                      <p class="justify-content-left" ><i class="fas fa-tag"></i>&nbsp;&nbsp;Special PriceGet extra 25% off (price inclusive of discount)T&C</p>
                                                                      <p class="justify-content-left"><i class="fas fa-tag">
                                           ...
                                           <div role="tabpanel" class="tab-pane fade" id="buzz4">
                                              <div class="row">
                                                     <div class="col-md-4">
                                                           <img src="http://localhost/punjabi/images/Micozy_side1.jpeg" width="69%">
                                                      </div>
                                                       ...
                                                       <div class="col-md-8">
                                                               ...
                                                               <div class="container py-3">
                                                                        <h5>Women Skater Pink Dress</h5><br>
                                                                        <i class="fas fa-rupee-sign text-center">&nbsp;&nbsp;
                                                                        <span style="color:black;">274</span></i><br>
                                                                            <br>
                                                                         <h4>Available offers</h4>
                                                                        <p class="justify-content-left" ><i class="fas fa-tag"></i>&nbsp;&nbsp;Special PriceGet extra 25% off (price inclusive of discount)T&C</p>
                                                                       <p class="justify-content-left"><i class="fas fa-tag"></i>&nbsp;&nbsp;Bank Offer15% Instant discount on first Flipkart Pay Later order of 500 and aboveT&C</p>
...
<!---------modal closed------>
  <div class="card-body">
    <h5 class="card-title">Micozy</h5>
    <p class="card-text">Women Skater Pink Dress.</p>
     <p><i class="fas fa-rupee-sign text-center">&nbsp;&nbsp;<span style="color:black;">274</span></i><br><br>
    <i class="fas fa-star"><i class="fas fa-star"><i class="fas fa-star-half-alt"><i class="far fa-star"></i></i></i></i></i></p>
...
<a data-toggle="modal" data-target="#exampleModa7">
 <img class="card-img-top" src="http://localhost/punjabi/images/w1.jpeg" alt="Card image cap">
</a>
...
<div class="modal fade" id="exampleModa7" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">BuyNewTrend    </h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      ...
      <!------------------------tabs started------------------------------>
                                              ...
                                              <li class="nav-item">
                                                  <a class="nav-link active" href="#pf7" role="tab" data-toggle="tab">
                                                            <img src="http://localhost/punjabi/images/w1.jpeg"  height="123px" width="40%">
                                                    </a>
                                              </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" href="#buzz7" role="tab" data-toggle="tab">
                                                         <img src="http://localhost/punjabi/images/w2.jpeg" height="123px" width="40%">
                                                     </a>
                                                </li>
                                       ...
                                       <div class="tab-content modal-lg">
                                           <div role="tabpanel" class="tab-pane fade show active" id="pf7">
                                                 <div class="row">
                                                     <div class="col-md-4">
                                                           <img src="http://localhost/punjabi/images/w1.jpeg" height="373px" width="60%">
                                                      </div>
                                                      <div class="col-md-8">
                                                            <div class="container py-3">
                                                                     <h5>Women Pinafore Black Dress</h5><br>
                                                                      <i class="fas fa-rupee-sign text-center">&nbsp;&nbsp;<span style="color:black;">430</span></i><br>
                                                                       <br>
                                                                      <h4>Available offers</h4>
                                                                      <p class="justify-content-left" ><i class="fas fa-tag"></i>&nbsp;&nbsp;Special PriceGet extra 25% off (price inclusive of discount)T&C</p>
                                                                      <p class="justify-content-left"><i class="fas fa-tag">
                                           ...
                                           <div role="tabpanel" class="tab-pane fade" id="buzz7">
                                              <div class="row">
                                                     <div class="col-md-4">
                                                           <img src="http://localhost/punjabi/images/w2.jpeg" height="373px" width="69%">
                                                      </div>
                                                       ...
                                                       <div class="col-md-8">
                                                               ...
                                                               <div class="container py-3">
                                                                        <h5>Women Pinafore Black Dress</h5><br>
                                                                        <i class="fas fa-rupee-sign text-center">&nbsp;&nbsp;
                                                                        <span style="color:black;">430</span></i><br>
                                                                            <br>
                                                                         <h4>Available offers</h4>
                                                                        <p class="justify-content-left" ><i class="fas fa-tag"></i>&nbsp;&nbsp;Special PriceGet extra 25% off (price inclusive of discount)T&C</p>
                                                                       <p class="justify-content-left"><i class="fas fa-tag"></i>&nbsp;&nbsp;Bank Offer15% Instant discount on first Flipkart Pay Later order of 500 and aboveT&C</p>
...
<!---------modal closed------>
  <div class="card-body">
    <h5 class="card-title">BuyNewTrend  </h5>
    <p class="card-text">Women Pinafore Black Dress</p>
     <p><i class="fas fa-rupee-sign text-center">&nbsp;&nbsp;<span style="color:black;">430</span></i><br><br>
    <i class="fas fa-star"><i class="fas fa-star"><i class="fas fa-star-half-alt"><i class="far fa-star"></i></i></i></i></i></p>
 ...
 <img class="card-img-top" src="http://localhost/punjabi/images/Tokyo.jpeg"  alt="Card image cap">
</a>
...
<div class="modal fade" id="exampleModa6" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Tokyo Talkies      </h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      ...
      <!------------------------tabs started------------------------------>
                                              ...
                                              <li class="nav-item">
                                                  <a class="nav-link active" href="#pf6" role="tab" data-toggle="tab">
                                                            <img src="http://localhost/punjabi/images/Tokyo.jpeg"  height="123px" width="45%">
                                                    </a>
                                              </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" href="#buzz6" role="tab" data-toggle="tab">
                                                         <img src="http://localhost/punjabi/images/Tokyo_side.jpeg" height="123px" width="45%">
                                                     </a>
                                                </li>
                                                                                           </ul>
                                       ...
                                       <div class="tab-content modal-lg">
                                           <div role="tabpanel" class="tab-pane fade show active" id="pf6">
                                                 <div class="row">
                                                     <div class="col-md-4">
                                                           <img src="http://localhost/punjabi/images/Tokyo.jpeg" height="373px" width="60%">
                                                      </div>
                                                      <div class="col-md-8">
                                                            <div class="container py-3">
                                                                     <h5>Women Maxi Multicolor Dress</h5><br>
                                                                      <i class="fas fa-rupee-sign text-center">&nbsp;&nbsp;<span style="color:black;">490</span></i><br>
                                                                       <br>
                                                                      <h4>Available offers</h4>
                                                                      <p class="justify-content-left" ><i class="fas fa-tag"></i>&nbsp;&nbsp;Special PriceGet extra 25% off (price inclusive of discount)T&C</p>
                                                                      <p class="justify-content-left"><i class="fas fa-tag">
                                           ...
                                           <div role="tabpanel" class="tab-pane fade" id="buzz6">
                                              <div class="row">
                                                     <div class="col-md-4">
                                                           <img src="http://localhost/punjabi/images/Tokyo_side.jpeg" height="373px" width="69%">
                                                      </div>
                                                       ...
                                                       <div class="col-md-8">
                                                               ...
                                                               <div class="container py-3">
                                                                        <h5>Women Maxi Multicolor Dress</h5><br>
                                                                        <i class="fas fa-rupee-sign text-center">&nbsp;&nbsp;
                                                                        <span style="color:black;">490</span></i><br>
                                                                            <br>
                                                                         <h4>Available offers</h4>
                                                                        <p class="justify-content-left" ><i class="fas fa-tag"></i>&nbsp;&nbsp;Special PriceGet extra 25% off (price inclusive of discount)T&C</p>
                                                                       <p class="justify-content-left"><i class="fas fa-tag"></i>&nbsp;&nbsp;Bank Offer15% Instant discount on first Flipkart Pay Later order of 500 and aboveT&C</p>
...
<!---------modal closed------>
  <div class="card-body">
    <h5 class="card-title">Tokyo Talkies </h5>
    <p class="card-text">Women Maxi Multicolor Dress</p>
     <p><i class="fas fa-rupee-sign text-center">&nbsp;&nbsp;<span style="color:black;">490</span></i><br><br>
    <i class="fas fa-star"><i class="fas fa-star"><i class="fas fa-star-half-alt"><i class="far fa-star"></i></i></i></i></i></p>
 ...
 <img class="card-img-top" src="http://localhost/punjabi/images/Rudraaksha_s.jpeg" alt="Card image cap">
</a>
      ...
      <!------------------------tabs started------------------------------>
                                              ...
                                              <li class="nav-item">
                                                  <a class="nav-link active" href="#pf5" role="tab" data-toggle="tab">
                                                            <img src="http://localhost/punjabi/images/Rudraaksha_s.jpeg"  height="123px" width="40%">
                                                    </a>
                                              </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" href="#buzz5" role="tab" data-toggle="tab">
                                                         <img src="http://localhost/punjabi/images/Rudraaksha_s_side1.jpeg" height="123px" width="40%">
                                                     </a>
                                                </li>
                                                <li class="nav-item">
                                                      <a class="nav-link" href="#references5" role="tab" data-toggle="tab" >
                                                           <img src="http://localhost/punjabi/images/Rudraaksha_s_side2.jpeg">
                                                      </a>
                                                </li>
                                       ...
                                       <div class="tab-content modal-lg">
                                           <div role="tabpanel" class="tab-pane fade show active" id="pf5">
                                                 <div class="row">
                                                     <div class="col-md-4">
                                                           <img src="http://localhost/punjabi/images/Rudraaksha_s.jpeg">
                                                      </div>
                                                      <div class="col-md-8">
                                                            <div class="container py-3">
                                                                     <h5>Women Fit and Flare Pink Dress With Mask</h5><br>
                                                                      <i class="fas fa-rupee-sign text-center">&nbsp;&nbsp;<span style="color:black;">388</span></i><br>
                                                                       <br>
                                                                      <h4>Available offers</h4>
                                                                      <p class="justify-content-left" ><i class="fas fa-tag"></i>&nbsp;&nbsp;Special PriceGet extra 25% off (price inclusive of discount)T&C</p>
                                                                      <p class="justify-content-left"><i class="fas fa-tag">
                                           ...
                                           <div role="tabpanel" class="tab-pane fade" id="buzz5">
                                              <div class="row">
                                                     <div class="col-md-4">
                                                           <img src="http://localhost/punjabi/images/Rudraaksha_s_side1.jpeg">
                                                      </div>
                                                       ...
                                                       <div class="col-md-8">
                                                               ...
                                                               <div class="container py-3">
                                                                        <h5>Women Fit and Flare Pink Dress With Mask</h5><br>
                                                                        <i class="fas fa-rupee-sign text-center">&nbsp;&nbsp;
                                                                        <span style="color:black;">388</span></i><br>
                                                                            <br>
                                                                         <h4>Available offers</h4>
                                                                        <p class="justify-content-left" ><i class="fas fa-tag"></i>&nbsp;&nbsp;Special PriceGet extra 25% off (price inclusive of discount)T&C</p>
                                                                       <p class="justify-content-left"><i class="fas fa-tag"></i>&nbsp;&nbsp;Bank Offer15% Instant discount on first Flipkart Pay Later order of 500 and aboveT&C</p>
                                          ...
                                          <div role="tabpanel" class="tab-pane fade" id="references5">
                                                <div class="row">
                                                    <div class="col-md-4">
                                                          <img src="http://localhost/punjabi/images/Rudraaksha_s_side2.jpeg" width="70%">
                                                     </div>
                                                     <div class="col-md-8">
                                                          <div class="container py-3">
                                                                <h5>Women Fit and Flare Pink Dress With Mask</h5><br>
...
<!---------modal closed------>
  <div class="card-body">
    <h5 class="card-title">Rudraaksha</h5>
    <p class="card-text">Women Fit and Flare Pink Dress With Mask.</p>
     <p><i class="fas fa-rupee-sign text-center">&nbsp;&nbsp;<span style="color:black;">388</span></i><br><br>
    <i class="fas fa-star"><i class="fas fa-star"><i class="fas fa-star-half-alt"><i class="far fa-star"></i></i></i></i></i></p>
