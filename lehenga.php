...
<div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
  <div class="carousel-inner">
      <div class="carousel-item active">
         <img class="d-block w-100" src="http://localhost/punjabi/images/lehenga2_use1.jpg" alt="First slide">
      </div>
       <div class="carousel-item">
         <img class="d-block w-100" src="http://localhost/punjabi/images/lehenga2_use2.jpg" alt="Second slide">
       </div>
       <div class="carousel-item">
          <img class="d-block w-100" src="http://localhost/punjabi/images/lehenga2_use3.jpg" alt="Third slide">
       </div>
  </div>
...
<section class="services py-5 text-center">
  <h3 class="text-center " id="h12">Lehengas</h3>
  <hr id="hr1">
          <div class="container">
              <div class="row">
                  <!--Single Service-->
...
<a data-toggle="modal" data-target="#exampleModa2">
 <img class="card-img-top" src="http://localhost/punjabi/images/jayci.jpeg" alt="Card image cap">
</a>
  ...
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Jayci Mart  </h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      ...
      <!------------------------tabs started------------------------------>
                                              ...
                                              <li class="nav-item">
                                                  <a class="nav-link active" href="#pf1" role="tab" data-toggle="tab">
                                                            <img src="http://localhost/punjabi/images/jayci.jpeg"  height="123px" width="40%">
                                                    </a>
                                              </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" href="#buzz1" role="tab" data-toggle="tab">
                                                         <img src="http://localhost/punjabi/images/jayci_side1.jpeg" height="123px" width="40%">
                                                     </a>
                                                </li>
                                                <li class="nav-item">
                                                      <a class="nav-link" href="#references1" role="tab" data-toggle="tab" >
                                                           <img src="http://localhost/punjabi/images/jayci_side2.jpeg" height="123px" width="40%">
                                                      </a>
                                                </li>
                                                <li class="nav-item">
                                                       <a class="nav-link" href="#imgur1" role="tab" data-toggle="tab" >
                                                           <img src="http://localhost/punjabi/images/jayci_side3.jpeg" height="123px" width="40%">
                                                       </a>
                                                 </li>
                                            </ul>
                                       ...
                                       <div class="tab-content modal-lg">
                                           <div role="tabpanel" class="tab-pane fade show active" id="pf1">
                                                 <div class="row">
                                                     <div class="col-md-4">
                                                           <img src="http://localhost/punjabi/images/jayci.jpeg" height="373px" width="60%">
                                                      </div>
                                                      <div class="col-md-8">
                                                            <div class="container py-3">
                                                                     <h5>Embroidered Semi Stitched Lehenga Choli  (Yellow)</h5><br>
                                           ...
                                           <div role="tabpanel" class="tab-pane fade" id="buzz1">
                                              <div class="row">
                                                     <div class="col-md-4">
                                                           <img src="http://localhost/punjabi/images/jayci_side1.jpeg" height="373px" width="69%">
                                                      </div>
                                          ...
                                          <div role="tabpanel" class="tab-pane fade" id="references1">
                                                <div class="row">
                                                    <div class="col-md-4">
                                                          <img src="http://localhost/punjabi/images/jayci_side2.jpeg"  height="373px" width="69%">
                                                     </div>
                                                     <div class="col-md-8">
                                                          <div class="container py-3">
                                                                <h5>Embroidered Semi Stitched Lehenga Choli  (Yellow)</h5><br>
                                         ...
                                         <div role="tabpanel" class="tab-pane fade" id="imgur1">
                                               <div class="row">
                                                   <div class="col-md-4">
                                                          <img src="http://localhost/punjabi/images/jayci_side3.jpeg" height="373px" width="69%">
                                                    </div>
...
<!---------modal closed------>
  <div class="card-body">
    <h5 class="card-title">Jayci Mart  </h5>
    <p class="card-text">Embroidered Semi Stitched Lehenga Choli  (Yellow)</p>
     <p><i class="fas fa-rupee-sign text-center">&nbsp;&nbsp;<span style="color:black;">4,999</span></i><br><br>
 ...
 <img class="card-img-top" src="http://localhost/punjabi/images/san.jpeg" alt="Card image cap">
</a>
...
<div class="modal fade" id="exampleModa3" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Santokba</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      ...
      <!------------------------tabs started------------------------------>
                                              ...
                                              <li class="nav-item">
                                                  <a class="nav-link active" href="#pf3" role="tab" data-toggle="tab">
                                                            <img src="http://localhost/punjabi/images/san.jpeg"  height="123px" width="45%">
                                                    </a>
                                              </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" href="#buzz3" role="tab" data-toggle="tab">
                                                         <img src="http://localhost/punjabi/images/san_side.jpeg" height="123px" width="45%">
                                                     </a>
                                                </li>
                                       ...
                                       <div class="tab-content modal-lg">
                                           <div role="tabpanel" class="tab-pane fade show active" id="pf3">
                                                 <div class="row">
                                                     <div class="col-md-4">
                                                           <img src="http://localhost/punjabi/images/san.jpeg" height="373px" width="60%">
                                                      </div>
                                                      <div class="col-md-8">
                                                            <div class="container py-3">
                                           ...
                                           <div role="tabpanel" class="tab-pane fade" id="buzz3">
                                              <div class="row">
                                                     <div class="col-md-4">
                                                           <img src="http://localhost/punjabi/images/san_side.jpeg" height="373px" width="69%">
                                                      </div>
...
<!---------modal closed------>
  <div class="card-body">
    <h5 class="card-title">R&H COMAPANY  </h5>
    <p class="card-text">Self Design Semi Stitched Lehenga Choli  (Pink).</p>
     <p><i class="fas fa-rupee-sign text-center">&nbsp;&nbsp;<span style="color:black;">4,34</span></i><br><br>
    <i class="fas fa-star"><i class="fas fa-star"><i class="fas fa-star-half-alt"><i class="far fa-star"></i></i></i></i></i></p>
 ...
 <img class="card-img-top" src="http://localhost/punjabi/images/mohnish.jpeg" alt="Card image cap">
</a>
...
<div class="modal fade" id="exampleModa4" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Mohnish Fashion 
                                                                      </h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      ...
      <!------------------------tabs started------------------------------>
                                              ...
                                              <li class="nav-item">
                                                  <a class="nav-link active" href="#pf4" role="tab" data-toggle="tab">
                                                            <img src="http://localhost/punjabi/images/mohnish.jpeg"  height="123px" width="45%">
                                                    </a>
                                              </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" href="#buzz4" role="tab" data-toggle="tab">
                                                         <img src="http://localhost/punjabi/images/mohnish_side.jpeg" height="123px" width="45%">
                                                     </a>
                                                </li>
                                       ...
                                       <div class="tab-content modal-lg">
                                           <div role="tabpanel" class="tab-pane fade show active" id="pf4">
                                                 <div class="row">
                                                     <div class="col-md-4">
                                                           <img src="http://localhost/punjabi/images/mohnish.jpeg" height="373px" width="60%">
                                                      </div>
                                                      <div class="col-md-8">
                                                            <div class="container py-3">
                                                                     <h5>Embroidered Semi Stitched Lehenga Choli  (Blue, Gold)</h5><br>
                                                                      <i class="fas fa-rupee-sign text-center">&nbsp;&nbsp;<span style="color:black;">11,00</span></i><br>
                                                                       <br>
                                                                      <h4>Available offers</h4>
                                                                      <p class="justify-content-left" ><i class="fas fa-tag"></i>&nbsp;&nbsp;Special PriceGet extra 25% off (price inclusive of discount)T&C</p>
                                                                      <p class="justify-content-left"><i class="fas fa-tag">
                                           ...
                                           <div role="tabpanel" class="tab-pane fade" id="buzz4">
                                              <div class="row">
                                                     <div class="col-md-4">
                                                           <img src="http://localhost/punjabi/images/mohnish_side.jpeg" width="69%">
                                                      </div>
                                                       ...
                                                       <div class="col-md-8">
                                                               ...
                                                               <div class="container py-3">
                                                                        <h5>Embroidered Semi Stitched Lehenga Choli  (Blue, Gold)</h5><br>
                                                                        <i class="fas fa-rupee-sign text-center">&nbsp;&nbsp;
                                                                        <span style="color:black;">11,00</span></i><br>
                                                                            <br>
                                                                         <h4>Available offers</h4>
                                                                        <p class="justify-content-left" ><i class="fas fa-tag"></i>&nbsp;&nbsp;Special PriceGet extra 25% off (price inclusive of discount)T&C</p>
                                                                       <p class="justify-content-left"><i class="fas fa-tag"></i>&nbsp;&nbsp;Bank Offer15% Instant discount on first Flipkart Pay Later order of 500 and aboveT&C</p>
...
<!---------modal closed------>
  <div class="card-body">
    <h5 class="card-title">Mohnish Fashion</h5>
    <p class="card-text">Embroidered Semi Stitched Lehenga Choli  (Blue, Gold)  (Unstitched).</p>
     <p><i class="fas fa-rupee-sign text-center">&nbsp;&nbsp;<span style="color:black;">1,100</span></i><br><br>
    <i class="fas fa-star"><i class="fas fa-star"><i class="fas fa-star-half-alt"><i class="far fa-star"></i></i></i></i></i></p>
...
<a data-toggle="modal" data-target="#exampleModa7">
 <img class="card-img-top" src="http://localhost/punjabi/images/kedar.jpeg" alt="Card image cap">
</a>
      ...
      <!------------------------tabs started------------------------------>
                                              ...
                                              <li class="nav-item">
                                                  <a class="nav-link active" href="#pf7" role="tab" data-toggle="tab">
                                                            <img src="http://localhost/punjabi/images/kedar.jpeg"  height="123px" width="40%">
                                                    </a>
                                              </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" href="#buzz7" role="tab" data-toggle="tab">
                                                         <img src="http://localhost/punjabi/images/kedar_side.jpeg" height="123px" width="40%">
                                                     </a>
                                                </li>
                                       ...
                                       <div class="tab-content modal-lg">
                                           <div role="tabpanel" class="tab-pane fade show active" id="pf7">
                                                 <div class="row">
                                                     <div class="col-md-4">
                                                           <img src="http://localhost/punjabi/images/kedar.jpeg" height="373px" width="60%">
                                                      </div>
                                                      <div class="col-md-8">
                                                            <div class="container py-3">
                                                                     <h5>Embroidered Semi Stitched Lehenga Choli  (Green)</h5><br>
                                                                      <i class="fas fa-rupee-sign text-center">&nbsp;&nbsp;<span style="color:black;">719</span></i><br>
                                                                       <br>
                                                                      <h4>Available offers</h4>
                                                                      <p class="justify-content-left" ><i class="fas fa-tag"></i>&nbsp;&nbsp;Special PriceGet extra 25% off (price inclusive of discount)T&C</p>
                                                                      <p class="justify-content-left"><i class="fas fa-tag">
                                           ...
                                           <div role="tabpanel" class="tab-pane fade" id="buzz7">
                                              <div class="row">
                                                     <div class="col-md-4">
                                                           <img src="http://localhost/punjabi/images/kedar_side.jpeg" height="373px" width="69%">
                                                      </div>
                                                       ...
                                                       <div class="col-md-8">
                                                               ...
                                                               <div class="container py-3">
                                                                        <h5>Embroidered Semi Stitched Lehenga Choli  (Green)</h5><br>
                                                                        <i class="fas fa-rupee-sign text-center">&nbsp;&nbsp;
                                                                        <span style="color:black;">7,19</span></i><br>
                                                                            <br>
                                                                         <h4>Available offers</h4>
                                                                        <p class="justify-content-left" ><i class="fas fa-tag"></i>&nbsp;&nbsp;Special PriceGet extra 25% off (price inclusive of discount)T&C</p>
                                                                       <p class="justify-content-left"><i class="fas fa-tag"></i>&nbsp;&nbsp;Bank Offer15% Instant discount on first Flipkart Pay Later order of 500 and aboveT&C</p>
...
<!---------modal closed------>
  <div class="card-body">
    ...
    <p class="card-text">Embroidered Semi Stitched Lehenga Choli  (Green)</p>
     <p><i class="fas fa-rupee-sign text-center">&nbsp;&nbsp;<span style="color:black;">7,19</span></i><br><br>
    <i class="fas fa-star"><i class="fas fa-star"><i class="fas fa-star-half-alt"><i class="far fa-star"></i></i></i></i></i></p>
 ...
 <img class="card-img-top" src="http://localhost/punjabi/images/feb.jpeg" alt="Card image cap">
</a>
...
<div class="modal fade" id="exampleModa6" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Fabcartz    </h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      ...
      <!------------------------tabs started------------------------------>
                                              ...
                                              <li class="nav-item">
                                                  <a class="nav-link active" href="#pf6" role="tab" data-toggle="tab">
                                                            <img src="http://localhost/punjabi/images/feb.jpeg"  height="123px" width="45%">
                                                    </a>
                                              </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" href="#buzz6" role="tab" data-toggle="tab">
                                                         <img src="http://localhost/punjabi/images/feb_side.jpeg" height="123px" width="45%">
                                                     </a>
                                                </li>
                                                                                           </ul>
                                       ...
                                       <div class="tab-content modal-lg">
                                           <div role="tabpanel" class="tab-pane fade show active" id="pf6">
                                                 <div class="row">
                                                     <div class="col-md-4">
                                                           <img src="http://localhost/punjabi/images/feb.jpeg" height="373px" width="60%">
                                                      </div>
                                                      <div class="col-md-8">
                                                            <div class="container py-3">
                                                                     <h5>Embroidered Semi Stitched Lehenga Choli  (Blue, Beige)</h5><br>
                                                                      <i class="fas fa-rupee-sign text-center">&nbsp;&nbsp;<span style="color:black;">499</span></i><br>
                                                                       <br>
                                                                      <h4>Available offers</h4>
                                                                      <p class="justify-content-left" ><i class="fas fa-tag"></i>&nbsp;&nbsp;Special PriceGet extra 25% off (price inclusive of discount)T&C</p>
                                                                      <p class="justify-content-left"><i class="fas fa-tag">
                                           ...
                                           <div role="tabpanel" class="tab-pane fade" id="buzz6">
                                              <div class="row">
                                                     <div class="col-md-4">
                                                           <img src="http://localhost/punjabi/images/feb_side.jpeg" height="373px" width="69%">
                                                      </div>
                                                       ...
                                                       <div class="col-md-8">
                                                               ...
                                                               <div class="container py-3">
                                                                        <h5>Embroidered Semi Stitched Lehenga Choli  (Blue, Beige)</h5><br>
                                                                        <i class="fas fa-rupee-sign text-center">&nbsp;&nbsp;
                                                                        <span style="color:black;">499</span></i><br>
                                                                            <br>
                                                                         <h4>Available offers</h4>
                                                                        <p class="justify-content-left" ><i class="fas fa-tag"></i>&nbsp;&nbsp;Special PriceGet extra 25% off (price inclusive of discount)T&C</p>
                                                                       <p class="justify-content-left"><i class="fas fa-tag"></i>&nbsp;&nbsp;Bank Offer15% Instant discount on first Flipkart Pay Later order of 500 and aboveT&C</p>
...
<!---------modal closed------>
  <div class="card-body">
    <h5 class="card-title">Fabcartz </h5>
    <p class="card-text">Embroidered Semi Stitched Lehenga Choli  (Blue, Beige)</p>
     <p><i class="fas fa-rupee-sign text-center">&nbsp;&nbsp;<span style="color:black;">999</span></i><br><br>
    <i class="fas fa-star"><i class="fas fa-star"><i class="fas fa-star-half-alt"><i class="far fa-star"></i></i></i></i></i></p>
 ...
 <img class="card-img-top" src="http://localhost/punjabi/images/ramk.jpeg" alt="Card image cap">
</a>
...
<div class="modal fade" id="exampleModa5" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">RamKrupa Creation  </h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      ...
      <!------------------------tabs started------------------------------>
                                              ...
                                              <li class="nav-item">
                                                  <a class="nav-link active" href="#pf5" role="tab" data-toggle="tab">
                                                            <img src="http://localhost/punjabi/images/ramk.jpeg"  height="123px" width="40%">
                                                    </a>
                                              </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" href="#buzz5" role="tab" data-toggle="tab">
                                                         <img src="http://localhost/punjabi/images/ramk_side1.jpeg" height="123px" width="40%">
                                                     </a>
                                                </li>
                                                <li class="nav-item">
                                                      <a class="nav-link" href="#references5" role="tab" data-toggle="tab" >
                                                           <img src="http://localhost/punjabi/images/ramk_side2.jpeg">
                                                      </a>
                                                </li>
                                       ...
                                       <div class="tab-content modal-lg">
                                           <div role="tabpanel" class="tab-pane fade show active" id="pf5">
                                                 <div class="row">
                                                     <div class="col-md-4">
                                                           <img src="http://localhost/punjabi/images/ramk.jpeg">
                                                      </div>
                                                      <div class="col-md-8">
                                                            <div class="container py-3">
                                                                     <h5>Embroidered Semi Stitched Lehenga Choli  (Red)</h5><br>
                                           ...
                                           <div role="tabpanel" class="tab-pane fade" id="buzz5">
                                              <div class="row">
                                                     <div class="col-md-4">
                                                           <img src="http://localhost/punjabi/images/ramk_side1.jpeg">
                                                      </div>
                                          ...
                                          <div role="tabpanel" class="tab-pane fade" id="references5">
                                                <div class="row">
                                                    <div class="col-md-4">
                                                          <img src="http://localhost/punjabi/images/ramk_side2.jpeg" width="70%">
                                                     </div>
                                                     <div class="col-md-8">
                                                          <div class="container py-3">
                                                                <h5>Embroidered Semi Stitched Lehenga Choli  (Red)</h5><br>
...
<!---------modal closed------>
  <div class="card-body">
    <h5 class="card-title">RamKrupa Creation  </h5>
    <p class="card-text">Embroidered Semi Stitched Lehenga Choli  (Red).</p>
     <p><i class="fas fa-rupee-sign text-center">&nbsp;&nbsp;<span style="color:black;">899</span></i><br><br>
    <i class="fas fa-star"><i class="fas fa-star"><i class="fas fa-star-half-alt"><i class="far fa-star"></i></i></i></i></i></p>
